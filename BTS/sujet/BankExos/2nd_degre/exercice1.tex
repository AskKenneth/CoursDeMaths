...
On a donc: \Answer{$\mathcal{S} = \left\lbrace -1 ; \dfrac{5}{3} \right\rbrace$}

Le polynôme se factorise donc: 

\Answer{$P(x) = -3(x+1) \left(x-\frac{5}{3} \right)$}
}
...
On a donc: \Answer{$\mathcal{S} = \left\lbrace -\dfrac{2}{3} ; 1 \right\rbrace$}

Le polynôme se factorise donc: 

\Answer{$P(x) = 3(x-1) \left(x+\frac{2}{3} \right)$}
}
